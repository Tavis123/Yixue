...
public class SystemCodeGenerator {
	...
	public static void main(String[] args) {
		...
		gc.setOutputDir(System.getProperty("user.dir") + "/yixue-generator/src/main/java");
		gc.setAuthor("Tavis");
		gc.setOpen(false);
		...
		dsc.setUrl("jdbc:mysql://192.168.101.65:3306/xyixue_" + SERVICE_NAME
